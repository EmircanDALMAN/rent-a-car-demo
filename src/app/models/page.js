       ...
       <div className="models-div__box__img">
        ...
        <div className="models-div__box__descr">
         ...
         <div className="models-div__box__descr__name-price__btn">
          <span onClick={() => window.scrollTo(0, 0)} href="/">
           Book Ride
          </span>
         </div>
        </div>
